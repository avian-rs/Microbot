...
public enum Activity {
    ...
    CRAFTING_BLOOD_RUNES("Crafting blood runes", Category.SKILLING_RUNECRAFT, ActivityIntensity.LOW),
    ...
    CRAFTING_BLOODS_TRUE_ALTAR("Crafting bloods at true altar", Category.SKILLING_RUNECRAFT, ActivityIntensity.LOW),
    ...
    SMELTING_ADAMANTITE_BARS_AT_BLAST_FURNACE("Smelting adamantite bars at Blast Furnace", Category.SKILLING_SMITHING, ActivityIntensity.LOW),
    ...
    SMELTING_STEEL_BARS_AT_BLAST_FURNACE("Smelting steel bars at Blast Furnace", Category.SKILLING_SMITHING, ActivityIntensity.LOW),
